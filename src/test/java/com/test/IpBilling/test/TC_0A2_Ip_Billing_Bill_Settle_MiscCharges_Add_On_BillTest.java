 ...
 * 12-Feb-2026
 */
public class TC_0A2_Ip_Billing_Bill_Settle_MiscCharges_Add_On_BillTest extends ADT_Admit_Patient{
	...
	private final String sheetName_Add_On_Bill = "Ip_Bill_Add_on_Bill";
	...
	public void AdmitPatient(String Facility, String Station, String Title, String Gender, String DOB, String FatherName, String M_Status,
			String Address, String City, String Nationality, String ABCPin, String Speciality, String Referred, String Stay, String Source, String BedType,
			String Alloted_bed_type_drp ,String Ward, String Package_Speciality, String KinName, String Relation, String Name, String BillingCo,
			String ClinicalCo) 
	...
	@Test(dataProvider = "LabclearanceDataProvider", priority = 5 , enabled = true)
...
//3. Company Details, This Details Only In After Company Update 
		Ip_Billing.ClickOnCompanyDetailsIcon("Click On Company Details Icon");
		Ip_Billing.RadioBtnInCreditLimitAndEnterCreaditLimit("Credit Limit Radio Btn" , "11");
		Ip_Billing.CheckBoxCopyBillAmount("Check Box In Copy Bill Amount");
		Ip_Billing.SaveCompanyDetails_PatientInsuranceApprovalPop("Click On Save Update Credit Limit");
		Ip_Billing.CloseCompanyDetails_PatientInsuranceApprovalPop("Close Company Details Patient Insurance Approval Pop");

//4. Bill Details	
		Ip_Billing.BillDetailsIconAndClosePop("Click On Bill Details Icon" , "Close Bill Details Pop");
		Thread.sleep(2000);

//5. Surgery Breakup Details
...
//8.Bill Settlement
		...
		Ip_Billing.BillSettlementReasonAndSavePop(Bill_Settlement_Reason_Text , "Save Bill Settlemet pop");  //Pop Some Time 
...
//8. Print Btn 
		...
		//Thread.sleep(2000);
		//Ip_Billing.ClickOnBillMenuIcon("Click On Bill menu Icon");
	...
	public Object[][] getMiscellaneousChargesData() throws IOException {
		...
		System.out.println("====Fetching data from Excel sheet_08 : " + sheetName_Miscellaneous + " ====");
		return ExcelSheetDataProvider.getExcelData(sheetName_Miscellaneous);
	}

	@Test(dataProvider = "MiscellaneousChargesDataProvider", priority = 8 , enabled = true)
	public void EnterUHID_IpNumber_MiscellaneousCharges(String Dashborad_Facility_Drp , String Ip_Billing_Station_Drp ,
		...
		logger = extent.createTest(" Miscellaneous Charges On Ip Number", " Ip Bill Miscellaneous Charges Dischage Patient");

		Miscellaneous_Charges.MiscellaneousCharges_page("Click On Ip Billing Drp","Miscellanceous Charrges Page");
		Miscellaneous_Charges.EnterIpNumberInMiscellanceCherges(CommanUtill.capturedIP);
		Miscellaneous_Charges.DischargePatientYespop("Yes Pop still want to make transactions In Miss Charge");
	...
	//=================Ip Billing Add On Bill=================================

	@DataProvider(name = "AddOnBillDataProvider")
	public Object[][] getAddData() throws IOException {

		System.out.println("====Fetching data from Excel sheet_09 : " + sheetName_Add_On_Bill + " ====");
		return ExcelSheetDataProvider.getExcelData(sheetName_Add_On_Bill);
	}

	@Test(dataProvider = "AddOnBillDataProvider", priority = 9 , enabled = true)
	public void IpBillingAddOnBill(String Dashborad_Facility_Drp) throws IOException, InterruptedException, InvalidApplicationException {

		logger = extent.createTest("Add On Bill", "After Miscellaneous Charges Add On Bill");

		Ip_Billing.IpBillingPage1("Click On Ip Billing Drp","Ip Billing Page");
		Thread.sleep(2000);
		Ip_Billing.EnterIpNumberInAllClearancePatient(CommanUtill.capturedIP);
		Ip_Billing.AfterDischargeOkPop("Discharge Patient Ok Button");   //Again Hit IP Number In Bill Genrate Patient
		//9.Add On Bill
		Ip_Billing.ClickOnAddOnBillIcon_RadioBtnGeneateAddonBillIfrormation("Click On Add On Bill Icon" ,
				"Click On Radio Btn Generate Add-On Bil" , "Generate Yes pop" ,"Yes Pop This transaction CantNot Reverted");

		Ip_Billing.ClickOnAddOnBill_SettleAddOnBillRadioBtnInformation("Click On Add On Bill Icon", "Click On Radio Btn Settle Add On Bill" ,
				"Yes Settle pop");

		Ip_Billing.SaveAddOnReceiptIPBillingBillSettlement("All Settle In Case Receipt Btn" ,"Receipt Yes Pop" , "Ok Receipt Number pop");
		Thread.sleep(500);
		Ip_Billing.PrintradioBtnAddOnBill("Add On Bill Icon" , "Print Add-On Bill Radio Btn" , "Print Yes Pop");
	}
