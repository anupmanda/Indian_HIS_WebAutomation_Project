 ...
 * Funclility Use Admit Patient Nursing Acknowledge + Discharge + Clearnace , Pharmacy Discharge Notification , Lab Clearnace ,
  ...
  Bill Dischharge + Acknowledge , 1. Update Company Details  2. Bill Details 3. Company Details Thumb , 
  4. Bill Discharge 5. Bill Ready 6. Bill Genrate 7.Full Bill Settlement 8. Add On Bill
 
 **********************************************************************************************************************/
public class TC_0A2_AddOnBillInMiscellaneousChargesTest extends AcknowledgeDischargeNotificationPage{
	...
	public Object[][] getDischargeData() throws IOException {
		...
		System.out.println("====Fetching data from Excel sheet_07 : " + sheetName_Discharge + " ====");
	...
	public Object[][] getBillingData() throws IOException {
		...
		System.out.println("====Fetching data from Excel sheet:08" + sheetName_IpBill + " ====");
	...
	@Test(dataProvider = "IpBilingDataProvider", priority = 11 , enabled = true)
	...
	@Test(dataProvider = "IpBilingDataProvider", priority = 12 , enabled = true)
	...
	@Test(dataProvider = "IpBilingDataProvider", priority = 13 , enabled = true)
	...
	@Test(dataProvider = "IpBilingDataProvider", priority = 14 , enabled = true)
	...
	//====================Misc Charges Code Add on Bill ================================
	@DataProvider(name = "MiscellaneousChargesDataProvider")
	public Object[][] getMiscellaneousChargesData() throws IOException {

		System.out.println("====Fetching data from Excel sheet 06: " + sheetName_Miscellaneous + " ====");
		return ExcelSheetDataProvider.getExcelData(sheetName_Miscellaneous);
	}

	@Test(dataProvider = "MiscellaneousChargesDataProvider", priority = 15 , enabled = true)
	public void EnterUHID_IpNumber_MiscellaneousCharges(String Dashborad_Facility_Drp , String Ip_Billing_Station_Drp ,
		...
		Miscellaneous_Charges.DischargePatientYespop("Do you still want to make transactions?");
