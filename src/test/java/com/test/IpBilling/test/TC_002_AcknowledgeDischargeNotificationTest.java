 ...
 * 29-Jan-2026
 */
public class TC_002_AcknowledgeDischargeNotificationTest extends AcknowledgeDischargeNotificationPage{
	...
	public void CheckDischagedPatient(String Dashborad_Facility_Drp , String Ip_Billing_Station_Drp , String Wards_Drp , 
		...
		logger = extent.createTest("Acknowledge Discharge Notification Test", "Discharged Patient");
	...
	@Test(dataProvider = "DischargeNotificationDataProvider", priority = 2 , enabled = true)
