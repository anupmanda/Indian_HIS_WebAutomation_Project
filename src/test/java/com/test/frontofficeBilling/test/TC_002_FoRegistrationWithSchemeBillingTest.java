 ...
 * 04-Dec-2025
 */
public class TC_002_FoRegistrationWithSchemeBillingTest extends FrontOfficeBillingPage {
	...
	public Object[][] getRegistrationData() throws IOException {
		...
		System.out.println("====TC_002 Fetching data from Excel sheet: " + Fo_Registration + " ====");
	...
	public Object[][] getBillingData() throws IOException {
		...
		System.out.println("====TC_002 Fetching data from Excel sheet: " + Billing_sheet +" ====");
