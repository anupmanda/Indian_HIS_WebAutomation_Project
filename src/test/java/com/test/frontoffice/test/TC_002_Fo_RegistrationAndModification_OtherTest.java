...
public class TC_002_Fo_RegistrationAndModification_OtherTest extends FrontOfficePatientRegistrationPage {
	...
	public Object[][] getData() throws IOException {
		System.out.println("====TC_003_Fetching data from Excel sheet: " + sheetName + " ====");
		return ExcelSheetDataProvider.getExcelData(sheetName);
	}

	@Test(dataProvider = "ExcelUniversalDataProvider", priority = 1)
	public void ModificationOfPatientRegistration(String Facility_Drp, String Station_Drp, String title_drp, String First_name_text, 
		...
		logger = extent.createTest("TC_003 Front Office Registration", "Front Office Patient Registration with All Required Fields");
	...
	public void modificationOPRegistration(String Facility_Drp, String Station_Drp, String title_drp, String First_name_text, 
		...
		logger = extent.createTest("Front Office Modification", "Front Office Modification Test using previously stored UHID");
	...
	public void FrontOfficeSaveVaccineDetails(String Facility_Drp, String Station_Drp, String title_drp, String First_name_text, 
		...
		logger = extent.createTest("TC_003 Register Patient Enter And Vaccine Details", "Save Vaccine Details Popup");
	...
	public void FrontOfficeVaccineDelete(String Facility_Drp, String Station_Drp, String title_drp, String First_name_text, 
		...
		logger = extent.createTest("TC_003 Register Patient Enter And Vaccine Delete", "Delete Vaccine Details Popup");
	...
	public void FrontOfficeOPDCardPrint(String Facility_Drp, String Station_Drp, String title_drp, String First_name_text, 
		...
		logger = extent.createTest("TC_003 Register Patient Enter And OPD Card Print", "OPD Register Card");
	...
	public void FrontOfficeFinancialDetails(String Facility_Drp, String Station_Drp, String title_drp, String First_name_text, 
		...
		logger = extent.createTest("TC_003 Register On Financial Details ", "Register On Financial Details Save");
