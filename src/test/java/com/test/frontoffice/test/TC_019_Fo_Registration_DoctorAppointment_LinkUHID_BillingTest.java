 ...
 * 01-Dec-2025
 */
public class TC_019_Fo_Registration_DoctorAppointment_LinkUHID_BillingTest extends FrontOfficePatientRegistrationPage {
	...
	public void FoAppointmentInLinkUHIDAndBilling(String Facility_Drp ,String Station_Drp , String Specility_Drp , 
		...
		logger = extent.createTest("TC_010 Front Office Appointment Link UHID Billing ", "Fo Appointment And Link UHID And Billing");
		...
		appointment.selectFirstAvailableDateAndTimeGreenSlot();   //Accouding to Aviable Slot Click in Current Date  
