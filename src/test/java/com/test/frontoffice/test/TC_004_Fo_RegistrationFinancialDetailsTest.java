 ...
 * 27-Nov-2025
 */
public class TC_003_Fo_RegistrationFinancialDetailsTest extends FrontOfficePatientRegistrationPage{
...
public FrontOfficePatientRegistrationPage frontofficeregistration = new FrontOfficePatientRegistrationPage();
	...
	public Object[][] getData() throws IOException {
		...
		System.out.println("====TC_003Fetching data from Excel sheet: " + sheetName +" ====");
