 ...
 * 15-Dec-2025
 */
public class MergeAndUnmergeDuplicateTest extends MergeAndUnmergeDuplicatePage {
	...
	public MergeAndUnmergeDuplicateTest() {
		super();
	}
	...
	public void DuplicateUnMergePatient(String Facility_Drp , String Strion_Drp) throws InterruptedException, IOException {
        ...
        logger = extent.createTest("UnMerge Duplicate Patient Test" ,"This Test Case Will Verify UnMerge Duplicate Patient Functionality");
        
        if (GlobalSecondaryUHID == null || GlobalSecondaryUHID.isEmpty()) {
       ...
       // Further steps to perform unmerge operation can be added here
       // unmergePatient.enterUHIDInUnmergePage(GlobalSecondaryUHID);
