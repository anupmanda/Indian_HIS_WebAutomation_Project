 ...
 * 27-Nov-2025
 */
public class TC_004_Fo_RegistrationKinDetailsTest extends FrontOfficePatientRegistrationPage {
	...
	public Object[][] getData() throws IOException {
		...
		System.out.println("====TC_004_Fetching data from Excel sheet: " + sheetName +" ====");
		return ExcelSheetDataProvider.getExcelData(sheetName);
	}

	@Test(dataProvider = "ExcelUniversalDataProvider" , priority = 1)	
		
	public void PatientRegistrationWithKinDetails(String Facility_Drp, String Station_Drp, String title_drp, String First_name_text, 
		...
		logger = extent.createTest("Front Office Registration Kin Details ", "Front Office Patient Registration with All Required Fields");
