...
public class FoBillsUtilityPage extends GeneralBrowserSetting{
	...
	//-----------------------Bills Utility Dues Settlement-----------------------

	protected static String dues_settlement_btn = "//a[@id='opbilldiagnostic']";
	protected static String dues_settlement_Amount = "//input[@id='settleAmt1']";
	protected static String dues_settlement_Discount_chkk = "//input[@id='chkwriteOff']";
	protected static String dues_settlement_discount_amount = "//input[@id='dueSettle']";
	protected static String dues_settlement_discount_head = "//select[@id='disHead']";
	protected static String dues_settlement_discount_reason = "//select[@id='disReason']";
	protected static String dues_settlement_Authorized_By = "//select[@id='authBy']";
	protected static String dues_settlement_Remaks_txt = "//input[@id='Headremarks']";
	protected static String dues_settlement_Cash_mop_payment = "//a[@id='addpaymentmode']//i[@class='fa fa-plus']";
	protected static String dues_settlement_Save_btn = "//a[@id='make_payment']";
	protected static String dues_settlement_Yes_popup = "//a[@id='duepaymentyes']";
	...
	//-----------------------Bills Utility Dues Settlement-----------------------
	public void DuesSettlementButton(String duesSettlementBtn) throws IOException , InterruptedException {

		CommanUtill.clickFunction(dues_settlement_btn, duesSettlementBtn);
	}
	public void enterDuesSettlementAmount(String settlementAmount) throws IOException , InterruptedException {

		CommanUtill.textEnter(dues_settlement_Amount, settlementAmount);
	}
	
	public void DuesSettlementDiscountCheckbox(String discountChkk) throws IOException , InterruptedException {

		CommanUtill.clickFunction(dues_settlement_Discount_chkk, discountChkk);
	}
	public void enterDuesSettlementDiscountAmount(String discountAmount) throws IOException , InterruptedException {

		CommanUtill.textEnter(dues_settlement_discount_amount, discountAmount);
	}
	public void DuesSettlementDiscountHeadAndReason(String discountHead_Dro , String discountReason_drp , String authorized_by_drp , String Due_settement_Discount_Remaks ) 
			throws IOException , InterruptedException {

		CommanUtill.dropdownSelectByVisibleText(dues_settlement_discount_head, discountHead_Dro);
		CommanUtill.dropdownSelectByVisibleText(dues_settlement_discount_reason, discountReason_drp);
		CommanUtill.dropdownSelectByVisibleText(dues_settlement_Authorized_By, authorized_by_drp);
		CommanUtill.textEnter(dues_settlement_Remaks_txt, Due_settement_Discount_Remaks);
	}
	public void DuesSettlementCashMopPayment(String cashMopPaymentBtn) 
			throws IOException, InterruptedException {

		CommanUtill.clickFunction(dues_settlement_Cash_mop_payment, cashMopPaymentBtn);
	}
	public void DuesSettlementSaveButtonAndYesPopup(String dues_settlement_SaveBtn , String dues_settlement_YesPopup) 
			throws IOException, InterruptedException {

		CommanUtill.clickFunction(dues_settlement_Save_btn, dues_settlement_SaveBtn);
		CommanUtill.clickFunction(dues_settlement_Yes_popup, dues_settlement_YesPopup);
	}
