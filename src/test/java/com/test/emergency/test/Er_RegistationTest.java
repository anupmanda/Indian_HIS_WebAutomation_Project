 ...
 * 17-Mar-2026
 */
public class Er_RegistationTest extends Er_RegistrationPage{
	...
	public void ErCompanyInsuranceDetailsTest(String facility_drp, String Station_drp, String title_drp, String First_Name, String 
		...
		Registration.CompanyInsurnceRadioBtn("Radio Btn In Company Insurance Btn");
		...
		@Test(dataProvider = "ExcelUniversalDataProvider" , priority = 4 ,enabled = false)	
		...
		@Test(dataProvider = "ExcelUniversalDataProvider" , priority = 6 ,enabled = false)	
		...
		@Test(dataProvider = "ExcelUniversalDataProvider" , priority = 7 ,enabled = false)	
		...
		public void PatientUploadDocumentTest() 
			...
			Registration.selectByFacilityDropdown("SANITY HOSPITAL");
			Registration.clickOnEmergencyDashbord_StationDrpYesPop("Emergency DashBord Button" ,"Emergency", "Station On Yes Popup");

			Registration.clickOnEmercencyPage("Emercency Button in side Icon","Emercency Register Page");
			Registration.enterErNumber("1508814");
		...
		public Object[][] getAdmitData() throws IOException {
			System.out.println("====Sheet Name: " + sheetName_Admit_Ip + "======");
