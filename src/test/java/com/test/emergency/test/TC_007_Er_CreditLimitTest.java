...
import com.test.emergency.page.ErCreditLimitPage;
 ...
 * 20-Mar-2026
 */
public class TC_007_Er_CreditLimitTest extends ErCreditLimitPage {
	
	ErCreditLimitPage New_CreditLimit = new ErCreditLimitPage();
	Er_RegistrationPage Registration = new Er_RegistrationPage();
	
	private final String sheetName = "Er_CreditLimitPage"; 

	@DataProvider(name = "ErCreditLimitDataProvider")
	...
	public void SaveEmergencyPatientTest() 
		...
		Registration.ClickMenuIcon("Click on Menu Icon Btn");
	}
