 ...
 * 23-Mar-2026
 */
public class ViewAdmission_SurgeryRequestTest extends ViewAdmission_SurgeryRequestPage {
	...
	public void ViewAdmissionSurgeryRequestTest(String facility_drp , String Station_drp , String Frome_Date , String To_Date , String Request_Type_Drp ,
		...
		//Admission_SurgeryRequest.selectBySpecilityDrp(Speciality_Drp);
		//Admission_SurgeryRequest.selectByDoctoreDrp(Doctor_Drp);
