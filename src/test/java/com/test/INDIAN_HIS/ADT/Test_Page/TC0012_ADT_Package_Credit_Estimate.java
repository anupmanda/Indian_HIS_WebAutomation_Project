 ...
 * 19 Dec 2025
 */
public class TC0012_ADT_Package_Credit_Estimate extends ADT_Surgery_Medical_Estimate{
	...
	public void PackageCreditEstimate(String Facility, String Station, String DOB, String Gender, String EstimateType, String BedType, String WardDays,
		...
		logger = extent.createTest("Package Credit Estimate", "Package Credit Estimate.........");
		
		sme.PackageEstimateCredit(Facility, Station, DOB, Gender, EstimateType, BedType, WardDays, SurgicalSpeciality, Surgery,
				OTDuration, SurgeonSpeciality, Surgeon, Anesthesia, RateContract, DepositAmount, Problem, Services, Item,
				ItemQuantity);
		Thread.sleep(1000);
